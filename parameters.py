...
#lepton masses added since original UFO had zero mass in particles.py
Me  = Parameter(name='Me',  nature='external', type='real',
                value=0.000510999, texname='\\text{Me}',  lhablock='MASS', lhacode=[11])

MMU = Parameter(name='MMU', nature='external', type='real',
                value=0.1056583745, texname='\\text{MMU}', lhablock='MASS', lhacode=[13])

MTA = Parameter(name='MTA', nature='external', type='real',
                value=1.77686, texname='\\text{MTA}', lhablock='MASS', lhacode=[15])
...
#added vev value, not originally in UFO file
vev = Parameter(
    name='vev', nature='internal', type='real',
    value='cmath.sqrt(1.0/(cmath.sqrt(2.0)*Gf))',  # v = (1/(sqrt(2)*Gf))^{1/2}
    texname='v',
    lhablock = 'SMINPUTS',
)
...
CKM1x3 = Parameter(name = 'CKM1x3',
                   nature = 'internal',
                   type = 'complex',
                   value = 'cmath.exp(-(dCP*complex(0,1)))*cmath.sin(th13)',
                   texname = '\\text{CKM1x3}')

CKM2x1 = Parameter(name = 'CKM2x1',
                   nature = 'internal',
                   type = 'complex',
                   value = '-(cmath.cos(th23)*cmath.sin(cabi)) - cmath.cos(cabi)*cmath.exp(dCP*complex(0,1))*cmath.sin(th13)*cmath.sin(th23)',
                   texname = '\\text{CKM2x1}')

CKM2x2 = Parameter(name = 'CKM2x2',
                   nature = 'internal',
                   type = 'complex',
                   value = 'cmath.cos(cabi)*cmath.cos(th23) - cmath.exp(dCP*complex(0,1))*cmath.sin(cabi)*cmath.sin(th13)*cmath.sin(th23)',
                   texname = '\\text{CKM2x2}')
...
CKM3x1 = Parameter(name = 'CKM3x1',
                   nature = 'internal',
                   type = 'complex',
                   value = '-(cmath.cos(cabi)*cmath.cos(th23)*cmath.exp(dCP*complex(0,1))*cmath.sin(th13)) + cmath.sin(cabi)*cmath.sin(th23)',
                   texname = '\\text{CKM3x1}')

CKM3x2 = Parameter(name = 'CKM3x2',
                   nature = 'internal',
                   type = 'complex',
                   value = '-(cmath.cos(th23)*cmath.exp(dCP*complex(0,1))*cmath.sin(cabi)*cmath.sin(th13)) - cmath.cos(cabi)*cmath.sin(th23)',
                   texname = '\\text{CKM3x2}')
...
# --- Cheng–Sher magnitudes and phases (LFV texture) ---
xi_em = Parameter(name='xi_em', nature='external', type='real',
                  value=1e-3, texname='\\xi_{e\\mu}', lhablock='ChengSher', lhacode=[1])

xi_et = Parameter(name='xi_et', nature='external', type='real',

                  value=1e-2, texname='\\xi_{e\\tau}', lhablock='ChengSher', lhacode=[2])

xi_mt = Parameter(name='xi_mt', nature='external', type='real',
                  value=1e-1, texname='\\xi_{\\mu\\tau}', lhablock='ChengSher', lhacode=[3])

phi_em = Parameter(name='phi_em', nature='external', type='real',
                   value=0.0, texname='\\phi_{e\\mu}', lhablock='ChengSherPhi', lhacode=[1])

phi_et = Parameter(name='phi_et', nature='external', type='real',
                   value=0.0, texname='\\phi_{e\\tau}', lhablock='ChengSherPhi', lhacode=[2])

phi_mt = Parameter(name='phi_mt', nature='external', type='real',
                   value=0.0, texname='\\phi_{\\mu\\tau}', lhablock='ChengSherPhi', lhacode=[3])

# Diagonal lepton entries (match SM for h when sinα≈1)
GLR1x1 = Parameter(name='GLR1x1', nature='internal', type='real',
                   value='(cmath.sqrt(2)*Me)/(vev*TH3x1)', texname='\\text{GLR11}', lhablock='yukawaglr')

GLI1x1 = Parameter(name='GLI1x1', nature='internal', type='real',
                   value='0', texname='\\text{GLI11}', lhablock='yukawagli')


GLR2x2 = Parameter(name='GLR2x2', nature='internal', type='real',
                   value='(cmath.sqrt(2)*MMU)/(vev*TH3x1)', texname='\\text{GLR22}',lhablock='yukawaglr')

GLI2x2 = Parameter(name='GLI2x2', nature='internal', type='real',
                   value='0', texname='\\text{GLI22}', lhablock='yukawagli')


GLR3x3 = Parameter(name='GLR3x3', nature='internal', type='real',
                   value='(cmath.sqrt(2)*MTA)/(vev*TH3x1)', texname='\\text{GLR33}', lhablock='yukawaglr')

GLI3x3 = Parameter(name='GLI3x3', nature='internal', type='real',
                   value='0', texname='\\text{GLI33}', lhablock='yukawagli')

# Helpers (write them inline or factor them if you prefer)
# e–μ
GLR1x2 = Parameter(name='GLR1x2', nature='internal', type='real',
  value='(cmath.sqrt(2)/(TH3x1))*xi_em*(cmath.sqrt(Me*MMU)/vev)*cmath.cos(phi_em)',
  texname='\\text{GLR12}', lhablock='yukawaglr')

GLI1x2 = Parameter(name='GLI1x2', nature='internal', type='real',
  value='(cmath.sqrt(2)/(TH3x1))*xi_em*(cmath.sqrt(Me*MMU)/vev)*cmath.sin(phi_em)',
  texname='\\text{GLI12}', lhablock='yukawagli')

GLR2x1 = Parameter(name='GLR2x1', nature='internal', type='real', value='GLR1x2', texname='\\text{GLR21}', lhablock='yukawaglr')

GLI2x1 = Parameter(name='GLI2x1', nature='internal', type='real', value='GLI1x2', texname='\\text{GLI21}', lhablock='yukawagli')

# e–τ
GLR1x3 = Parameter(name='GLR1x3', nature='internal', type='real',
  value='(cmath.sqrt(2)/(TH3x1))*xi_et*(cmath.sqrt(Me*MTA)/vev)*cmath.cos(phi_et)',
  texname='\\text{GLR13}', lhablock='yukawaglr')

GLI1x3 = Parameter(name='GLI1x3', nature='internal', type='real',
  value='(cmath.sqrt(2)/(TH3x1))*xi_et*(cmath.sqrt(Me*MTA)/vev)*cmath.sin(phi_et)',
  texname='\\text{GLI13}', lhablock='yukawagli')

GLR3x1 = Parameter(name='GLR3x1', nature='internal', type='real', value='GLR1x3', texname='\\text{GLR31}', lhablock='yukawaglr')

GLI3x1 = Parameter(name='GLI3x1', nature='internal', type='real', value='GLI1x3', texname='\\text{GLI31}', lhablock='yukawagli')

# μ–τ
GLR2x3 = Parameter(name='GLR2x3', nature='internal', type='real',
  value='(cmath.sqrt(2)/(TH3x1))*xi_mt*(cmath.sqrt(MMU*MTA)/vev)*cmath.cos(phi_mt)',
  texname='\\text{GLR23}', lhablock='yukawaglr')

GLI2x3 = Parameter(name='GLI2x3', nature='internal', type='real',
  value='(cmath.sqrt(2)/(TH3x1))*xi_mt*(cmath.sqrt(MMU*MTA)/vev)*cmath.sin(phi_mt)',
  texname='\\text{GLI23}', lhablock='yukawagli')

GLR3x2 = Parameter(name='GLR3x2', nature='internal', type='real', value='GLR2x3', texname='\\text{GLR32}', lhablock='yukawaglr')

GLI3x2 = Parameter(name='GLI3x2', nature='internal', type='real', value='GLI2x3', texname='\\text{GLI32}', lhablock='yukawagli')
